...
public class ViolationService {
    ...
    private Specification<Violation> byGuilty (Integer guilty) {
        return (root, query, builder) -> guilty == null ? builder.conjunction() : builder.equal(root.get("guilty").get("id"), guilty);
    }

    private Specification<Violation> byVehicle (Integer vehicle) {
    ...
    private Specification<Violation> byDate (Date date) {
    ...
    public ResponseObject getFiltered(ViolationFilter filter) {
        ...
        Specification<Violation> spec = Specification.where(byGuilty(filter.getGuilty()))
